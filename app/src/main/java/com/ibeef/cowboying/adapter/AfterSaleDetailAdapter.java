 ...
 **/
public class AfterSaleDetailAdapter extends BaseQuickAdapter<BaseBean,BaseViewHolder> {
    private Context context;
    public AfterSaleDetailAdapter(List data, Context context, int layout) {
        super(layout, data);
