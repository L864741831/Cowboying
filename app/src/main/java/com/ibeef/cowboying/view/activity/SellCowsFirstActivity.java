...
public class SellCowsFirstActivity extends BaseActivity implements SellCowsBase.IView {
    ...
    public void getSellCows(SellCowsResultBean sellCowsResultBean) {
        if("000000".equals(sellCowsResultBean.getCode())){
            ...
            float realMoney=(sellCowsResultBean.getBizData().getPrice().floatValue()*sellCowsResultBean.getBizData().getPastureNum())-sellCowsResultBean.getBizData().getDebt().floatValue()-sellCowsResultBean.getBizData().getBrokerage().floatValue()+sellCowsResultBean.getBizData().getEarn().floatValue();
