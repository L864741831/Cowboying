 ...
 */
public class AmountViewWhite extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public AmountViewWhite(Context context) {
        this(context, null);
    }

    public AmountViewWhite(Context context, AttributeSet attrs) {
        super(context, attrs);

        LayoutInflater.from(context).inflate(R.layout.view_amount_white, this);
