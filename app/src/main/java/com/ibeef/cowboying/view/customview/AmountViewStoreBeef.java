...
public class AmountViewStoreBeef extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public AmountViewStoreBeef(Context context) {
        this(context, null);
    }

    public AmountViewStoreBeef(Context context, AttributeSet attrs) {
        super(context, attrs);

        LayoutInflater.from(context).inflate(R.layout.view_amount_storebeef, this);
