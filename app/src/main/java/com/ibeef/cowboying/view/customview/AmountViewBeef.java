 ...
 */
public class AmountViewBeef extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public AmountViewBeef(Context context) {
        this(context, null);
    }

    public AmountViewBeef(Context context, AttributeSet attrs) {
        super(context, attrs);

        LayoutInflater.from(context).inflate(R.layout.view_amount_beef, this);
