...
public class AddMoneyModel implements AddMoneyBase.IModel {
    ...
    @Override
    public Subscription getAddMoney(Map<String, String> headers, final ResponseCallback<AddMoneyResultBean> callback) {
        Observable<AddMoneyResultBean> observable = service.getAddMoney(headers);
